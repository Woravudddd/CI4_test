...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light " >
  ...
  <div class='navbar-brand mx-3 md-3' style="font-size: 36px; font-weight: 900;  ;color :chartreuse; ">edit Employee</div>
...
<form method="post" action="<?=url_to('update',$user['id']) ?>">
  <div class="form-group row mt-3 ">
    <label for="fnamelabel " class="col-sm-2 col-form-label mt-2">First-Name</label>
    <div class="col-sm-10 mt-3">
      <input type="text" name="fname" class="form-control" id="fname" placeholder="First Name" value="<?= old('fname',$user['fname']); ?>">
    </div>
    <label for="lnamelabel" class="col-sm-2 col-form-label mt-2">Last-Name</label>
    <div class="col-sm-10 mt-3">
      <input type="text" name="lname" class="form-control" id="lname" placeholder="Last Name"  value="<?= old('lname',$user['lname']); ?>">
    </div>
    ...
    <div class="col-sm-10 mt-3">
      <input type="text" name="phone" class="form-control" id="phone" placeholder="Phone" value="<?= old('phone',$user['phone']); ?>">
    </div>
  </div>
